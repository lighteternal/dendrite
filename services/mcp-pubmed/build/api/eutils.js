...
import { parseXML, extractText, parsePubMedDate, RateLimiter, retryWithBackoff, buildQueryString } from './utils.js';
export class EUtilsClient {
    ...
    async getSimilarArticles(pmid, maxResults = 20) {
        ...
        return linkArray
            .slice(0, maxResults)
            .map((link) => extractText(link.Id));
    }
}
//# sourceMappingURL=eutils.js.map