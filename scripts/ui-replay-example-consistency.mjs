...
const outDir = process.env.DENDRITE_UI_OUT ?? "/tmp/dendrite-replay-examples";
const maxRunMs = Number(process.env.DENDRITE_UI_TIMEOUT_MS ?? 480000);
const sessionId = process.env.DENDRITE_SESSION_ID ?? `ui-audit-${Date.now()}`;
